...
router.put("/post/", (req, res, next) => {
    bot.modules.get("rolebuttons").postGroup(req.body.id, true).then(() => res.json({})).catch(e => next(e));
});

router.put("/update/", (req, res, next) => {
    bot.modules.get("rolebuttons").postGroup(req.body.id, false).then(() => res.json({})).catch(e => next(e));
});
